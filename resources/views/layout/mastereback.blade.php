...
<div class="wrapper">
  ...
  <!-- Main Sidebar Container -->
   <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <li class="nav-item d-none d-sm-inline-block">
      <a href="{{url('admin/permissions')}}" class="nav-link">Permissions</a>
    </li>
    <li class="nav-item d-none d-sm-inline-block">
      <a href="{{url('admin/rolepermission')}}" class="nav-link">Role Permission</a>
    </li>
    <li class="nav-item d-none d-sm-inline-block">
      <a href="{{url('admin/user')}}" class="nav-link">user view</a>
    </li>
    <li class="nav-item d-none d-sm-inline-block">
      <a href="{{url('admin/manager')}}" class="nav-link">Manager View</a>
    </li>
    {{-- <li class="nav-item">
